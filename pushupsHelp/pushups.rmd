...
$H_0$: There is no difference between the average pushups of line playersvs skill players that can be done in 2 minutes.

$H_A$: The average pushups of line players is statistically different than that of skill players that can be done in two minutes.
...
summary (players)
```
The table shows the overall results for all the team players average.
...
The question was "if there is a difference between the amount of pushups between the lined players and the skilled players that can be done in 2 minutes?"
...
The p-value is 9.42e-06, so we reject the null hypothesis and conclude theres is a difference between the number of puships that can be done in 2 minutes between the skilled players and the line players. 
